...
exports.getShow = async (req, res) => {
  try {
    ...
    if (!data) { return res.status(201).json({ success: true, message: `Data not founded` }); }
...
exports.postShow = async (req, res) => {
  ...
  try {
    let newShow = new Show({ address, location, showTitle, description, date, startTime, radius, utcDateTime, pre_show, premp3, main_show, mainmp3, localDateTime, post_show, postmp3, timezone });
    await newShow.save();
